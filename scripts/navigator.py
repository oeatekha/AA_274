...
class Navigator:
    ...
    def __init__(self):
        ...
        # navigation state
        # Hard Code for the keyboard to be false
        ...
        #rospy.Subscriber("/detector/objects". DetectedObjectList, self.detected_objects)
    ...
    def dyn_cfg_callback(self, config, level):
        rospy.loginfo(
            "Reconfigure Request: k1:{k1}, k2:{k2}, k3:{k3}, v1:{v1}".format(**config)
        )
        self.pose_controller.k1 = config["k1"]
        self.pose_controller.k2 = config["k2"]
        self.pose_controller.k3 = config["k3"]
        self.v_des = config["v1"]
        return config
